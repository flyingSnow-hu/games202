...
async function GAMES202Main() {
	...
	for (let i = 0; i < envmap.length; i++) {
		...
		// precomputeL [envIndex][sh Coffs x9][rgb]
	...
	function createGUI() {
		...
		panelModel.add(guiParams, 'envmapId', { 'CornellBox': 0, 'GraceGathedral': 1, 'Indoor': 2, 'Skybox': 3 , 'Skybox2': 4 }).name('Envmap Name');
		panelModel.open();
	}
