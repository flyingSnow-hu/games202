...
vec3 EvalDiffuse(vec3 wi, vec3 wo, vec2 uv) {
  ...
  return diff * albedo * uLightRadiance;
}
...
void main() {
  ...
  linearColor = EvalDiffuse(uLightDir, uCameraPos-vPosWorld.xyz, screenUV);
  linearColor = linearColor * EvalDirectionalLight(screenUV);
